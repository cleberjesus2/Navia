...
@Component({
  selector: 'app-oleonatural',
  templateUrl: './oleonatural.page.html',
  styleUrls: ['./oleonatural.page.scss'],
})
export class OleonaturalPage implements OnInit  {
  ...
  constructor(private http: HttpClient, private toastController: ToastController, private alertController: AlertController) { 
    ...
    this.produto = {
      nome: 'Óleo Natural',
      preco: '8,00',
      descricao: 'Óleo Natural dermatologicamente testado',
    };
  }
