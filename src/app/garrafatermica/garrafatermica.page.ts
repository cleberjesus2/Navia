...
@Component({
  selector: 'app-garrafatermica',
  templateUrl: './garrafatermica.page.html',
  styleUrls: ['./garrafatermica.page.scss'],
})
export class GarrafatermicaPage implements OnInit  {
  ...
  constructor(private http: HttpClient, private toastController: ToastController, private alertController: AlertController) { 
    ...
    this.produto = {
      ...
      preco: '14,00',
      descricao: 'Garrafa Térmica reutilizável',
    };
  }
