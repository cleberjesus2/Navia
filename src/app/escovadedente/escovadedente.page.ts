...
@Component({
  selector: 'app-escovadedente',
  templateUrl: './escovadedente.page.html',
  styleUrls: ['./escovadedente.page.scss'],
})
export class EscovadedentePage implements OnInit  {
  ...
  constructor(private http: HttpClient, private toastController: ToastController, private alertController: AlertController) { 
    ...
    this.produto = {
      ...
      preco: '8,00',
      descricao: 'Escova de dente com materiais de madeira',
    };
  }
