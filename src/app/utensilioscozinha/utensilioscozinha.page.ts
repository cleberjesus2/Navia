...
@Component({
  selector: 'app-utensilioscozinha',
  templateUrl: './utensilioscozinha.page.html',
  styleUrls: ['./utensilioscozinha.page.scss'],
})
export class UtensilioscozinhaPage implements OnInit {
  ...
  constructor(private http: HttpClient, private toastController: ToastController, private alertController: AlertController) { 
    ...
    this.produto = {
      ...
      preco: '19,00',
      descricao: 'Conjunto de utensílios de cozinha práticos e duráveis',
    };
  }
